...
(function(){
try {
   var timings = [ { marker: 'knitr', elapsed: 235850 }, { marker: 'pandoc', elapsed: 5360 }, { marker: 'post-processor', elapsed: 80 }, { marker: 'pre-processor', elapsed: 80 }, { marker: 'render', elapsed: 250600 } ];
